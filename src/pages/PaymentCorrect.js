  ...
  return (
    ...
    >
      <Grid container justifyContent="center" alignItems="center">
        <Grid item>
          <CheckCircleOutlineIcon fontSize="large" sx={{ color: "#35B900" }} />
        </Grid>
        <Grid item>
          <Typography variant="h4" sx={{ fontWeight: "bold", color: "#35B900" }}>
      ...
      We're happy to inform you that the purchase of the tickets has been successful!
             </Typography>
      <Typography variant="h6" sx={{ fontWeight: "bold", color:"gray", marginTop:"2rem" }}>        
      Check your inbox to view your tickets.
      </Typography>
      ...
      <Grid container justifyContent="center" alignItems="center" marginTop={"2rem"}>
        ...
        <Grid item sx={{ marginRight: "1rem" }}>
          <Link style={{ textDecoration: "none" }}
              to={`/Events`}
              key={"Events"} >
          <Button variant="contained">Event's List</Button>
          </Link>
        </Grid>
